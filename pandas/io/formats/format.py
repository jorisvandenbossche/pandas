...
class SeriesFormatter(object):
    ...
    def _get_formatted_values(self):
        #values_to_format = self.tr_series._values
        values_to_format = self.tr_series._data.blocks[0].formatted_values()
...
class DataFrameFormatter(TableFormatter):
    ...
    def _format_col(self, i):
        ...
        values_to_format = frame.iloc[:, i]._data.blocks[0].formatted_values()
